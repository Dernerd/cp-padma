...
<div class="notice notice-info padma-unlimited-notice-rate">
	...
	<div class="padma-unlimited-notice-rate-content">
		...
		<div class="padma-unlimited-notice-rate-content-text">
			<p><?php _e( 'Hallo bei CP Padma', 'padma' ); ?>,</p>
			<p><?php _e( 'Unser Team hat wirklich hart daran gearbeitet, Dir dieses leistungsstarke Tool zur Verfügung zu stellen. Wir hoffen, dass es Dir gefällt.', 'padma' ); ?></p>
			<h4><?php _e( 'Möchtest Du helfen dieses Theme weiter zu entwickeln?', 'padma' ); ?></h4>
			<ul>				
